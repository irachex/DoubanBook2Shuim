...
function getButton(url) {
    var btn;
    if (url != '') {
        btn = '<a href="'+url+'" style="float:left;display: inline-block;background: #33A057;border: 1px solid #2F7B4B;color: white;padding: 1px 10px;border-radius:3px;margin-right: 8px;" target="_blank">shu.im</a>';
    }
    else {
        btn = '<a href="javascript:void(0);" style="float:left;display: inline-block;background: #999;border: 1px solid #666;color: white;padding: 1px 10px;border-radius:3px;margin-right: 8px;" target="_blank">shu.im</a>';
    }
    return btn;
}
